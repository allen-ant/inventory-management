...
<style scoped>
/* Cards, tables, badges, stats, loading, and error states all come from the
   global design system in App.vue. Only chart layout stays local. */
...
.bar-label {
  ...
  white-space: nowrap;
  margin-top: var(--sp-6); /* extra clearance for the rotated label */
}

/* Status colors stay literal per design system (green/red are not tokenized) */
.positive-change {
  color: #16a34a;
  font-weight: 600;
}
