            ...
            <div class="task-form">
              ...
              <div class="form-row">
                ...
                <div class="form-group-btn">
                  <button @click="handleAddTask" class="btn task-add-btn" :disabled="!newTask.title.trim() || !newTask.dueDate">
                    {{ t('tasks.addTask') }}
                  </button>
                </div>
              </div>
...
/* .btn / .btn-secondary come from the global stylesheet in App.vue */
